...
<div class="list-group">
  ...
  <a type="button" class="list-group-item list-group-item-action list-group-item-warning js-admin-list-rendezVous" href="#admin/rendezVous/offres/list">Définir une offre de rendez-vous.</a>
  <% } %>
  <% if (isAdmin) { %>
